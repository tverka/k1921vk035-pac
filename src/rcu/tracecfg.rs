#[doc = "Register `TRACECFG` reader"]
pub type R = crate::R<TracecfgSpec>;
#[doc = "Register `TRACECFG` writer"]
pub type W = crate::W<TracecfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clken(&mut self) -> ClkenW<TracecfgSpec> {
        ClkenW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Clock source select"]
    #[inline(always)]
    #[must_use]
    pub fn clksel(&mut self) -> ClkselW<TracecfgSpec> {
        ClkselW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable divider"]
    #[inline(always)]
    #[must_use]
    pub fn diven(&mut self) -> DivenW<TracecfgSpec> {
        DivenW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Divider coefficient"]
    #[inline(always)]
    #[must_use]
    pub fn divn(&mut self) -> DivnW<TracecfgSpec> {
        DivnW::new(self, 24)
    }
}
#[doc = "Trace clock configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tracecfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tracecfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TracecfgSpec;
impl crate::RegisterSpec for TracecfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tracecfg::R`](R) reader structure"]
impl crate::Readable for TracecfgSpec {}
#[doc = "`write(|w| ..)` method takes [`tracecfg::W`](W) writer structure"]
impl crate::Writable for TracecfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TRACECFG to value 0"]
impl crate::Resettable for TracecfgSpec {
