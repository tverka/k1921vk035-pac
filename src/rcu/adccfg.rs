#[doc = "Register `ADCCFG` reader"]
pub type R = crate::R<AdccfgSpec>;
#[doc = "Register `ADCCFG` writer"]
pub type W = crate::W<AdccfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clken(&mut self) -> ClkenW<AdccfgSpec> {
        ClkenW::new(self, 0)
    }
    #[doc = "Bit 4 - Reset disable"]
    #[inline(always)]
    #[must_use]
    pub fn rstdis(&mut self) -> RstdisW<AdccfgSpec> {
        RstdisW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Clock source select"]
    #[inline(always)]
    #[must_use]
    pub fn clksel(&mut self) -> ClkselW<AdccfgSpec> {
        ClkselW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable divider"]
    #[inline(always)]
    #[must_use]
    pub fn diven(&mut self) -> DivenW<AdccfgSpec> {
        DivenW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Divider coefficient"]
    #[inline(always)]
    #[must_use]
    pub fn divn(&mut self) -> DivnW<AdccfgSpec> {
        DivnW::new(self, 24)
    }
}
#[doc = "ADC clock and reset configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adccfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adccfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdccfgSpec;
impl crate::RegisterSpec for AdccfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adccfg::R`](R) reader structure"]
impl crate::Readable for AdccfgSpec {}
#[doc = "`write(|w| ..)` method takes [`adccfg::W`](W) writer structure"]
impl crate::Writable for AdccfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCCFG to value 0"]
impl crate::Resettable for AdccfgSpec {
