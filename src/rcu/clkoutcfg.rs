...
pub type DivnW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ...
    #[doc = "Bits 24:26 - Divider coefficient"]
    #[inline(always)]
    pub fn divn(&self) -> DivnR {
        DivnR::new(((self.bits >> 24) & 7) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn clken(&mut self) -> ClkenW<ClkoutcfgSpec> {
        ClkenW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Clock source select"]
    #[inline(always)]
    #[must_use]
    pub fn clksel(&mut self) -> ClkselW<ClkoutcfgSpec> {
        ClkselW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable divider"]
    #[inline(always)]
    #[must_use]
    pub fn diven(&mut self) -> DivenW<ClkoutcfgSpec> {
        DivenW::new(self, 16)
    }
    #[doc = "Bits 24:26 - Divider coefficient"]
    #[inline(always)]
    #[must_use]
    pub fn divn(&mut self) -> DivnW<ClkoutcfgSpec> {
        DivnW::new(self, 24)
    }
}
