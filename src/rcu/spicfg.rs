...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clken(&mut self) -> ClkenW<SpicfgSpec> {
        ClkenW::new(self, 0)
    }
    #[doc = "Bit 4 - Reset disable"]
    #[inline(always)]
    #[must_use]
    pub fn rstdis(&mut self) -> RstdisW<SpicfgSpec> {
        RstdisW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Clock source select"]
    #[inline(always)]
    #[must_use]
    pub fn clksel(&mut self) -> ClkselW<SpicfgSpec> {
        ClkselW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable divider"]
    #[inline(always)]
    #[must_use]
    pub fn diven(&mut self) -> DivenW<SpicfgSpec> {
        DivenW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Divider coefficient"]
    #[inline(always)]
    #[must_use]
    pub fn divn(&mut self) -> DivnW<SpicfgSpec> {
        DivnW::new(self, 24)
    }
}
#[doc = "SPI clock and reset configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spicfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spicfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
