#[doc = "Register `AQCTLB` reader"]
pub type R = crate::R<AqctlbSpec>;
#[doc = "Register `AQCTLB` writer"]
pub type W = crate::W<AqctlbSpec>;
#[doc = "\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zro(&mut self) -> ZroW<AqctlbSpec> {
        ZroW::new(self, 0)
    }
    #[doc = "Bits 2:3"]
    #[inline(always)]
    #[must_use]
    pub fn prd(&mut self) -> PrdW<AqctlbSpec> {
        PrdW::new(self, 2)
    }
    #[doc = "Bits 4:5"]
    #[inline(always)]
    #[must_use]
    pub fn cau(&mut self) -> CauW<AqctlbSpec> {
        CauW::new(self, 4)
    }
    #[doc = "Bits 6:7"]
    #[inline(always)]
    #[must_use]
    pub fn cad(&mut self) -> CadW<AqctlbSpec> {
        CadW::new(self, 6)
    }
    #[doc = "Bits 8:9"]
    #[inline(always)]
    #[must_use]
    pub fn cbu(&mut self) -> CbuW<AqctlbSpec> {
        CbuW::new(self, 8)
    }
    #[doc = "Bits 10:11"]
    #[inline(always)]
    #[must_use]
    pub fn cbd(&mut self) -> CbdW<AqctlbSpec> {
        CbdW::new(self, 10)
    }
}
#[doc = "Action-Qualifier Output B Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`aqctlb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`aqctlb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AqctlbSpec;
impl crate::RegisterSpec for AqctlbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aqctlb::R`](R) reader structure"]
impl crate::Readable for AqctlbSpec {}
#[doc = "`write(|w| ..)` method takes [`aqctlb::W`](W) writer structure"]
impl crate::Writable for AqctlbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AQCTLB to value 0"]
impl crate::Resettable for AqctlbSpec {
