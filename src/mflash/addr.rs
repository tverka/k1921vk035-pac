...
#[doc = "Field `VAL` reader - Address value for flash operations"]
pub type ValR = crate::FieldReader<u32>;
#[doc = "Field `VAL` writer - Address value for flash operations"]
pub type ValW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Address value for flash operations"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn val(&mut self) -> ValW<AddrSpec> {
        ValW::new(self, 0)
    }
}
