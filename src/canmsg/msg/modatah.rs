...
#[doc = "Field `DB4` reader - Data byte 4 of message object"]
pub type Db4R = crate::FieldReader;
#[doc = "Field `DB4` writer - Data byte 4 of message object"]
pub type Db4W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `DB5` reader - Data byte 5 of message object"]
pub type Db5R = crate::FieldReader;
#[doc = "Field `DB5` writer - Data byte 5 of message object"]
pub type Db5W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `DB6` reader - Data byte 6 of message object"]
pub type Db6R = crate::FieldReader;
#[doc = "Field `DB6` writer - Data byte 6 of message object"]
pub type Db6W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `DB7` reader - Data byte 7 of message object"]
pub type Db7R = crate::FieldReader;
#[doc = "Field `DB7` writer - Data byte 7 of message object"]
pub type Db7W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Data byte 4 of message object"]
    #[inline(always)]
    pub fn db4(&self) -> Db4R {
        Db4R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Data byte 5 of message object"]
    #[inline(always)]
    pub fn db5(&self) -> Db5R {
        Db5R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Data byte 6 of message object"]
    #[inline(always)]
    pub fn db6(&self) -> Db6R {
        Db6R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Data byte 7 of message object"]
    #[inline(always)]
