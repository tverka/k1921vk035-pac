...
#[doc = "Field `DB0` reader - Data byte 0 of message object"]
pub type Db0R = crate::FieldReader;
#[doc = "Field `DB0` writer - Data byte 0 of message object"]
pub type Db0W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `DB1` reader - Data byte 1 of message object"]
pub type Db1R = crate::FieldReader;
#[doc = "Field `DB1` writer - Data byte 1 of message object"]
pub type Db1W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `DB2` reader - Data byte 2 of message object"]
pub type Db2R = crate::FieldReader;
#[doc = "Field `DB2` writer - Data byte 2 of message object"]
pub type Db2W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `DB3` reader - Data byte 3 of message object"]
pub type Db3R = crate::FieldReader;
#[doc = "Field `DB3` writer - Data byte 3 of message object"]
pub type Db3W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Data byte 0 of message object"]
    #[inline(always)]
    pub fn db0(&self) -> Db0R {
        Db0R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Data byte 1 of message object"]
    #[inline(always)]
    pub fn db1(&self) -> Db1R {
        Db1R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of message object"]
    #[inline(always)]
    pub fn db2(&self) -> Db2R {
        Db2R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Data byte 3 of message object"]
    #[inline(always)]
